# Generated by Django 2.0.3 on 2018-09-26 05:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verify', models.CharField(default='noresponse', max_length=20)),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Article', verbose_name='活动')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
